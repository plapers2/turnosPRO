    ...
    <div role="dialog" aria-modal="true" aria-labelledby="modal-title-complete"
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-outline-variant/20">
            <div class="flex items-center gap-3">
                <div
                    class="w-8 h-8 rounded-xl bg-[#E6F1FB] text-[#185FA5]
                            flex items-center justify-center border border-[#9EC8F0]">
                ...
                <h2 id="modal-title-complete" class="text-[15px] font-semibold text-on-surface">
                    Completar cita
                </h2>
            </div>
