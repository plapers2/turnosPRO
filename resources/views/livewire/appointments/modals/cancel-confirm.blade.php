...
<div class="modal-backdrop" wire:click.self="closeCancelModal">
    <div class="modal modal--sm" role="dialog" aria-modal="true" aria-labelledby="modal-title-cancel">
        ...
        <div class="modal__header">
            ...
            <button wire:click="closeCancelModal" class="modal__close" aria-label="Cerrar">
        ...
        <div class="modal__body">
            ...
            <textarea id="cancel-reason" wire:model="cancellationReason" rows="3"
                ...
                class="field-textarea {{ $errors->has('cancellationReason') ? 'field-textarea--error' : '' }}"></textarea>
        ...
        <div class="modal__footer">
            ...
            <button wire:click="closeCancelModal" class="btn btn--secondary">
                Volver
            </button>
        </div>
