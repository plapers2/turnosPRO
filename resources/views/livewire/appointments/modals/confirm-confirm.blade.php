    ...
    <div role="dialog" aria-modal="true" aria-labelledby="modal-title-confirm"
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-outline-variant/20">
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-xl bg-[#E1F5EE] text-[#0F6E56]
                            flex items-center justify-center border border-[#9FE1CB]">
                    <svg width="15" height="15" viewBox="0 0 14 14" fill="none">
                        <path d="M1.5 7.5l3 3 8-7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                <h2 id="modal-title-confirm" class="text-[15px] font-semibold text-on-surface">
                    Confirmar cita
                </h2>
            </div>
        ...
        <div class="p-5 flex flex-col gap-4">
            <div class="flex items-start gap-3 bg-[#E1F5EE] border border-[#9FE1CB] rounded-xl px-4 py-3">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none" class="flex-shrink-0 mt-0.5 text-[#0F6E56]">
                    <circle cx="8" cy="8" r="6.5" stroke="currentColor" stroke-width="1.5" />
                    <path d="M5 8.5l2 2 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p class="text-[13px] text-[#0F6E56] leading-snug">
                    ¿Confirmas esta cita? Se notificará al cliente y quedará registrada como
                    <strong class="font-semibold">confirmada</strong>.
                </p>
            </div>

            <div class="flex items-center gap-2.5 bg-surface-container rounded-xl px-3 py-2.5
                        border border-outline-variant/20">
                <svg width="13" height="13" viewBox="0 0 14 14" fill="none" class="text-on-surface-variant flex-shrink-0">
                ...
                <p class="text-[11.5px] text-on-surface-variant leading-snug">
                    El estado cambiará de <em>Pendiente</em> a <em>Confirmada</em>.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-2 px-5 py-4 border-t border-outline-variant/20">
            <button wire:click="confirmAppointment"
                wire:loading.attr="disabled" wire:target="confirmAppointment"
                ...
                <span wire:loading.remove wire:target="confirmAppointment" class="inline-flex items-center gap-1.5">
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                        <path d="M1.5 7l3 3 7-6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    Sí, confirmar
                </span>
                <span wire:loading wire:target="confirmAppointment" class="inline-flex items-center gap-1.5">
                    <svg class="animate-spin w-3.5 h-3.5" viewBox="0 0 14 14" fill="none">
                        <circle cx="7" cy="7" r="5.5" stroke="currentColor" stroke-width="1.5" stroke-dasharray="20" stroke-dashoffset="10" stroke-linecap="round" />
                    </svg>
                    Guardando…
                </span>
            </button>
