            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        @endphp
                        <div class="flex items-start justify-between gap-2 px-3 py-2 rounded-xl border
                            ...
                            <div class="flex items-center gap-1.5 flex-wrap">
                                ...
                                @endif
                                <span class="px-2 py-0.5 rounded-full font-semibold border {{ $logColor }}">
                                    {{ __('appt.status.' . $log->to_status) }}
                                </span>
                                @if ($log->changedBy)
                                <span class="text-on-surface-variant">por <strong>{{ $log->changedBy->name }}</strong></span>
                                @else
