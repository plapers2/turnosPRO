...
<div x-data="appointmentsManager({{ $company_id }})" class="appt-manager">
    ...
    @php
        // Huecos disponibles HOY para el profesional autenticado (o todos si admin).
        // Lógica ligera: reutiliza $availabilityDays si ya está calculado,
        // o simplemente muestra el badge de la semana.
    ...
    @if ($todayFreeSlots > 0 && $view !== 'availability')
        <div
            class="mx-4 mt-3 flex items-center justify-between gap-3
                bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-2.5 text-sm">
