<div>
    ...
    <div class="grid grid-cols-2 gap-3 px-4 pt-5 sm:px-8 lg:grid-cols-4">
        ...
        <div
            ...
            <div class="flex flex-col gap-0.5">
                <span class="text-[17px] font-semibold leading-none text-on-surface">{{ $activeCount - 1 }}</span>
        ...
        <div
            ...
            <div class="flex flex-col gap-0.5">
                <span class="text-[17px] font-semibold leading-none text-on-surface">{{ $roles->count() - 2 }}</span>
    ...
    <div class="flex flex-col gap-3 px-4 pt-5 sm:px-8 lg:flex-row lg:items-center">
        ...
        <div class="relative w-full lg:max-w-[200px]">
            ...
            <select wire:model.live="role"
                ...
                @foreach ($roles as $r)
                    @if ($r->name != 'cliente' && $r->name != 'master')
