                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;">
                            ...
                            <div style="text-align:center;margin-bottom:24px;">
                                <span style="display:inline-block;background:#fef2f2;color:#991b1b;font-size:12px;font-weight:600;padding:6px 16px;border-radius:99px;border:1px solid #fca5a5;letter-spacing:0.3px;">
                                    ❌ CITA CANCELADA
                                </span>
                            </div>
                            ...
                            <p style="margin:0 0 28px;color:#6b7280;font-size:14px;line-height:1.6;">
                                Lamentamos informarte que tu cita ha sido <strong style="color:#991b1b;">cancelada</strong> por el negocio. Si tienes dudas, contáctanos respondiendo este correo.
                            </p>
                            ...
                            <!-- Card motivo -->
                            <table width="100%" cellpadding="0" cellspacing="0"
                                style="background:#fef2f2;border-radius:12px;border:1px solid #fca5a5;overflow:hidden;margin-bottom:28px;">
                                <tr>
                                    <td style="padding:14px 20px;background:#991b1b;border-radius:12px 12px 0 0;">
                                        <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.8);font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Motivo de cancelación</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:16px 20px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:32px;vertical-align:middle;"><span style="font-size:18px;">💬</span></td>
                                                <td style="vertical-align:middle;padding-left:12px;">
                                                    <p style="margin:0;font-size:14px;color:#1c1b1f;line-height:1.6;">{{ $appointment->cancellation_reason }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;line-height:1.6;">
                                Si no esperabas esta cancelación o tienes dudas, contáctanos respondiendo este correo.
                            </p>
                        </td>
                    </tr>
