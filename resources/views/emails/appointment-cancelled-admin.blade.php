                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;">
                            ...
                            <h2 style="margin:0 0 8px;font-size:20px;color:#1c1b1f;font-weight:700;">Un cliente canceló su cita</h2>
                            <p style="margin:0 0 28px;color:#6b7280;font-size:14px;line-height:1.6;">
                                El slot ha quedado <strong style="color:#b45309;">libre</strong> automáticamente.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:14px 20px;background:#b45309;border-radius:12px 12px 0 0;">
                                        <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.8);font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Detalles de la cita cancelada</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:16px 20px;border-bottom:1px solid #e5e7eb;">
