                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;">
                            ...
                            <p style="margin:0 0 28px;color:#6b7280;font-size:14px;line-height:1.6;">
                                @if($tipo === '24h')
                                Te recordamos que tienes una cita <strong style="color:#b45309;">mañana</strong>. Aquí tienes los detalles:
                                @else
                                Tu cita comienza <strong style="color:#b45309;">en aproximadamente 1 hora</strong>. ¡No llegues tarde!
                                @endif
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;padding-left:12px;">
                                                    ...
                                                    <p style="margin:2px 0 0;font-size:14px;color:#1c1b1f;font-weight:600;">{{ $appointment->company->address }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <!-- Botón cancelar (solo si es recordatorio 24h) -->
                            @if($tipo === '24h')
