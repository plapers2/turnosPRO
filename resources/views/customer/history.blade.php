<x-app-layout>
    <main class="flex-1 flex flex-col relative h-full overflow-y-auto bg-surface">
        ...
        <!-- HEADER -->
        <x-header-admin icono="groups" titulo="Historial de Clientes" mensaje="Fidelidad y preferencias de tus clientes" />
                            ...
                            <tr class="hover:bg-surface/40 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-0.5">
                                        <span class="font-semibold text-on-surface">{{ $customer->name }}</span>
                                        <span class="text-xs text-on-surface-variant">{{ $customer->email }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-primary-fixed text-on-primary-fixed text-xs font-semibold font-label">
                    ...
                    <div class="bg-surface-container-lowest border border-outline-variant/20 rounded-xl p-4 shadow-sm">
                        <div class="flex items-start justify-between mb-2">
                            <div>
                                ...
                                <p class="text-xs text-on-surface-variant">{{ $customer->phone }}</p>
                            </div>
